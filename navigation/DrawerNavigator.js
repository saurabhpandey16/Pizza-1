    ...
    Builder: {
      ...
      navigationOptions: {
        drawerIcon: tabInformation => (
          <Icon name="cog" size={20} color={tabInformation.tintColor} />
        ),
      },
    },
    Account: {
      ...
      navigationOptions: {
        drawerIcon: tabInformation => (
          <Icon name="user" size={20} color={tabInformation.tintColor} />
        ),
      },
    },
    PollResults: {
      ...
      navigationOptions: {
        ...
        drawerIcon: tabInformation => (
          <Icon name="info" size={20} color={tabInformation.tintColor} />
        ),
      },
    },
  },
